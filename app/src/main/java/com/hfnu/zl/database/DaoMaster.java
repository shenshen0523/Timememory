...
public class DaoMaster extends AbstractDaoMaster {
    ...
    private DaoMaster(SQLiteDatabase db) {
     ...
     * @return
     */
    public static DaoMaster getDaoMaster(Context context,String dbName) {
        if (daoMaster == null) {
            sqliteDatabase=new DevOpenHelper(context,dbName, null).getWritableDatabase();
    ...
    public static DaoSession getDaoSession(Context context) {
        if (daoSession == null) {
            if (daoMaster == null) {
                daoMaster = getDaoMaster(context,"trip.db");
            }
